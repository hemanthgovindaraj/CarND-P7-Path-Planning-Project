        ...
        if (event == "telemetry") {
          ...
          for(auto sf_data:sensor_fusion)
          {
            ...
            if((check_car_s > car_s) && ((check_car_s-car_s)<30))
            {
              ...
              // set too close and vehicle in lane
          ...
          else if(vehicle_in_lane && (lane==1))
          {
            ...
            else if(!vehicle_in_right)
            {
              lane--;
            }
          }
          else if(vehicle_in_lane &&(lane==2))
          {
            if(!vehicle_in_right)
            {
              lane--;
          ...
          if((ref_vel<49.5)&&(!vehicle_in_lane))
          {
            ref_vel+=0.224;
          }
